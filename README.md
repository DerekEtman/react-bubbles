...
- [x] Explain what a token is used for.
    		...
    		Tokens provide a secure key that authorizes a user  to access a website

- [x] What steps can you take in your web apps to keep your data secure?

        Make sure your private pages route through a private route component

- [x] Describe how web servers work.

        Your web browser to requests a page This gets passed on to your modem which accesses your Local isp server that retrieves passes it back to your
